#
#  Be sure to run `pod spec lint HHO2View.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "huanghuacai"
  # s.authors            = { "huanghuacai" => "18811108252@163.com" }
  # s.social_media_url   = "http://twitter.com/huanghuacai"
